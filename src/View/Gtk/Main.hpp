...
class View_Gtk_Main : public View_Main {
	...
	public: View_Gtk_Main() :
		...
		miAboutEntryTypes(gettext("About the entry types"), true),
		miCAboutEntryTypes(gettext("About the entry types"), true),
	...
	{
		if (isBurgMode)
			win.set_title(Glib::ustring(gettext("Grub Customizer")) + "(" + Glib::ustring(gettext("BURG Mode")) + ")");
		else
			win.set_title(Glib::ustring(gettext("Grub Customizer")));
